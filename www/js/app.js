...
angular.module('iny', ['ionic','ngIOS9UIWebViewPatch', 'iny.controllers', 'iny.services', 'ngMaterial', 'ngStorage', 'ngMessages', 'ngCordova'])
    .run(function ($ionicPlatform, $cordovaSQLite, $rootScope, $ionicHistory, $state, $http, AuthUser, $mdDialog, $mdBottomSheet) {
